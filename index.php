  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          ?>
          <ul class="treeview-menu">
            <li><a href="index.php?page=penjualan"><i class="glyphicon glyphicon-tags"></i> <span>Data Penjualan Single</span></a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index.php?page=penjualan_multi"><i class="glyphicon glyphicon-tags"></i> <span>Data Penjualan Multi</span></a></li>
          </ul>
      </li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="index.php?page=transaksi_barang"><i class="glyphicon glyphicon-tag"></i> <span>Single</span></a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index.php?page=data_multibarang"><i class="glyphicon glyphicon-tag"></i> <span>Multi</span></a></li>
          </ul>
      </li>
